...
namespace Tabula.Tests
{
    public class TestTextElement
    {
		...
		public void mergeFourElementsIntoOneWord()
		{
			List<TextElement> elements = new List<TextElement>();
			elements.Add(new TextElement(new PdfRectangle(15, 0, 15 + 10, 0 + 20), UtilsForTesting.HELVETICA_BOLD, 1f, "A", 1f, 6f)); // 0f, 15f, 10f, 20f,
			elements.Add(new TextElement(new PdfRectangle(25, 0, 25 + 10, 0 + 20), UtilsForTesting.HELVETICA_BOLD, 1f, "B", 1f, 6f)); // 0f, 25f, 10f, 20f, 
			elements.Add(new TextElement(new PdfRectangle(35, 0, 35 + 10, 0 + 20), UtilsForTesting.HELVETICA_BOLD, 1f, "C", 1f, 6f)); // 0f, 35f, 10f, 20f,
			elements.Add(new TextElement(new PdfRectangle(45, 0, 45 + 10, 0 + 20), UtilsForTesting.HELVETICA_BOLD, 1f, "D", 1f, 6f)); // 0f, 45f, 10f, 20f,
		...
		public void mergeElementsShouldBeIdempotent()
		{
			...
			List<TextElement> elements = new List<TextElement>();
			elements.Add(new TextElement(new PdfRectangle(15, 0, 25, 20), UtilsForTesting.HELVETICA_BOLD, 1f, "A", 1f, 6f)); // 0f, 15f, 10f, 20f,
			elements.Add(new TextElement(new PdfRectangle(25, 0, 35, 20), UtilsForTesting.HELVETICA_BOLD, 1f, "B", 1f, 6f)); // 0f, 25f, 10f, 20f,
			elements.Add(new TextElement(new PdfRectangle(35, 0, 45, 20), UtilsForTesting.HELVETICA_BOLD, 1f, "C", 1f, 6f)); // 0f, 35f, 10f, 20f,
			elements.Add(new TextElement(new PdfRectangle(45, 0, 55, 20), UtilsForTesting.HELVETICA_BOLD, 1f, "D", 1f, 6f)); // 0f, 45f, 10f, 20f,
