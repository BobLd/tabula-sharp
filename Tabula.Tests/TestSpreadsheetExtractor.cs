...
namespace Tabula.Tests
{
    public class TestSpreadsheetExtractor
    {
        ...
        public void testAlmostIntersectingRulingsShouldIntersect()
        {
            ...
            Dictionary<PdfPoint, Ruling[]> m = Ruling.findIntersections(new Ruling[] { h }.ToList(), new Ruling[] { v }.ToList());
        ...
        {
            /*
            PageArea page = UtilsForTesting.getAreaFromFirstPage("Resources/Publication_of_award_of_Bids_for_Transport_Sector__August_2016.pdf", 56.925f, 24.255f, 549.945f, 786.555f);
